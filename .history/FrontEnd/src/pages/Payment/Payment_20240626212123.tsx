...
export default function Payment({ checkedPurchases, totalCheckedPurchasePrice, onPaymentSuccess }: Props) {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className='flex  m-5 font'>
        <div className='flex flex-col border-2 border-gray-100 rounded-lg p-3 w-full'>
        ...
        <div className='flex  w-full justify-center'>
          {isPayPalButtonSuccess ? ( // Check if payment is successful
            ...
            <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5 w-full'>
              <div className='mt-[20px]'>
                ...
                <p className='pt-[10px] text-[13px]  text-center'>
                  ...
                  <Link to={path.historyPurchase} className='text-[13px] font-bold hover:text-gray-500/80'>
                    Lịch sử mua hàng
                  </Link>
                </p>
              </div>
            ...
            <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5'>
              ...
              <button
                type='submit'
                className='border-solid border-2 border-blue w-[80px] mr-0 bg-blue rounded-md text-white p-1 hover:opacity-90'
              >
                Complete
              </button>
            </div>
