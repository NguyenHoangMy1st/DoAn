  ...
  return (
    <div className='bg-neutral-100 pt-10 pb-20'>
      <div className='container '>
        <div className='bg-white shadow mx-32 p-5 rounded-2xl'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7 pt-5 '>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='ml-4 rounded-2xl bg-[#b1261c] p-2 text-[10px]  text-white'>
              ...
              <div className='mt-8 flex items-center border-b pb-7 border-b-gray-200'>
                <button
                  onClick={addToCart}
                  className='flex h-12 items-center justify-center rounded-2xl border border-[#1CA7EC] bg-[#1CA7EC]/10 px-5 capitalize text-[#1CA7EC] shadow-sm hover:bg-[#1CA7EC]/5'
                >
                  <svg
                    ...
                    x={0}
                    y={0}
                    className='mr-[10px] h-5 w-5 fill-current stroke-[#1CA7EC] text-cyan-600'
                  >
                    <g>
                      <g>
                        <polyline
                ...
                <button
                  onClick={buyNow}
                  className='fkex ml-4 h-12 min-w-[5rem] items-center justify-center rounded-2xl bg-cyan-600 px-5 capitalize text-white shadow-sm outline-none hover:bg-cyan-600/80'
                >
                  Mua ngay
                </button>
              </div>
      ...
      <div className='container'>
        <div className='mt-8 bg-white shadow mx-32 p-5 rounded-2xl'>
