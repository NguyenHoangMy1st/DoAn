  ...
  return (
    <div className='flex justify-between text-sm pr-12 pl-4 bg-gradient-to-b from-[#1CA7EC] to-[#4ADEDE] text-white '>
      ...
      <div className='flex justify-end gap-1'>
          ...
          renderPopover={
            <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
              <div className='flex flex-col py-2 pr-28 pl-3'>
                <button className='py-2 px-3 text-left hover:text-red-400'>Tiếng Việt</button>
                <button className='mt-2 py-2 px-3 text-left hover:text-red-400'>English</button>
              </div>
            </div>
          }
        >
        ...
        {isAuthenticated && (
          <Popover
            className='flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6 rounded-2xl'
            renderPopover={
              <div className='bg-white relative shadow-md border border-gray-200  rounded-2xl'>
                <Link
                  to={path.profile}
                  className='block py-3 px-6 hover:bg-slate-100 bg-white hover:text-cyan-500 w-full text-left rounded-2xl'
                >
                  Tài khoản của tôi
                </Link>
                <Link
