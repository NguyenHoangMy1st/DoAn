  ...
  return (
    <div className='px-4 py-3'>
      ...
      <div className='w-full flex  items-center  justify-center mt-4'>
        <div className='flex  items-center  justify-center border-2 rounded-full w-[200px] h-[48px] bg-gradient-to-r from-[#0eb0f0] via-[#3331c4] to-[#1f3667] text-white text-base  '>
          <button
